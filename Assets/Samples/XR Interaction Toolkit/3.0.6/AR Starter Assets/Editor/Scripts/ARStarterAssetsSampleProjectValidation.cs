...
namespace UnityEditor.XR.Interaction.Toolkit.Samples.ARStarterAssets.Editor
{
    ...
    /// </summary>
    internal static class ARStarterAssetsSampleProjectValidation
    {
        private const string k_SampleDisplayName = "AR Starter Assets";
        ...
        private const string k_ARFPackageName = "com.unity.xr.arfoundation";
        private const string k_ARFPackageMinVersionString = "4.2.8";
        private const float k_TimeOutInSeconds = 3f;

        private static readonly PackageVersion s_ARFPackageMinVersion = new PackageVersion(k_ARFPackageMinVersionString);
        ...
        private static AddRequest s_ARFPackageAddRequest;
        ...
        private static string GetImportSampleVersionMessage(string packageFolderName, string sampleDisplayName, PackageVersion version)
        {
